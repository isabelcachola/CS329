...
austin <- get_googlemap(location= c(lon = -97.743061, lat = 30.267153), maptype = "roadmap",zoom = 11)
...
sa <- get_googlemap(location= c(lon = -98.493628, lat = 29.424122), maptype = "roadmap",zoom = 11)
ggmap(sa) + 
...
la <- get_googlemap(location= c(lon = -118.293685, lat = 34.052234), maptype = "roadmap",zoom = 11)
ggmap(la) + 
