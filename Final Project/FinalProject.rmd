...
fy14=dplyr::full_join(fy14_budgeted_student_enrollment_data,by=c("school_code","school_name","fiscal_year","school_type","ward"))
fy15=dplyr::full_join(fy15_budgeted_student_enrollment_data,by=c("school_code","school_name","fiscal_year","school_type","ward"))
